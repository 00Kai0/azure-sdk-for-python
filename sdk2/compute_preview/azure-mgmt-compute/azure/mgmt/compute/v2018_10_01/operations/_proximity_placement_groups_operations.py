...
class ProximityPlacementGroupsOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :type parameters: ~azure.mgmt.compute.v2018_10_01.models.ProximityPlacementGroup
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProximityPlacementGroup or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2018_10_01.models.ProximityPlacementGroup or ~azure.mgmt.compute.v2018_10_01.models.ProximityPlacementGroup
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ProximityPlacementGroupListResult"
        """Lists all proximity placement groups in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ProximityPlacementGroupListResult or the result of cls(response)
        :rtype: ~azure.mgmt.compute.v2018_10_01.models.ProximityPlacementGroupListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
