...
class GalleryApplicationVersionsOperations(object):
    ...
    def begin_update(
     ...
     :code:`<MajorVersion>`.:code:`<MinorVersion>`.:code:`<Patch>`.
        ...
        :type publishing_profile: ~azure.mgmt.compute.v2019_12_01.models.GalleryApplicationVersionPublishingProfile
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
    ...
    def list_by_gallery_application(
     ...
     Definition from which the Application Versions are to be listed.
        ...
        :rtype: ~azure.mgmt.compute.v2019_12_01.models.GalleryApplicationVersionList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
