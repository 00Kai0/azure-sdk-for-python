...
class ApiError(msrest.serialization.Model):
    ...
    :type details: list[~azure.mgmt.compute.v2016_03_30.models.ApiErrorBase]
    :param innererror: The Api inner error.
    :type innererror: ~azure.mgmt.compute.v2016_03_30.models.InnerError
...
class AvailabilitySet(Resource):
    ...
    :type virtual_machines: list[~azure.mgmt.compute.v2016_03_30.models.SubResource]
...
class AvailabilitySetListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.AvailabilitySet]
...
class DiagnosticsProfile(msrest.serialization.Model):
    ...
    :type boot_diagnostics: ~azure.mgmt.compute.v2016_03_30.models.BootDiagnostics
    """
...
class DiskEncryptionSettings(msrest.serialization.Model):
    ...
    :param disk_encryption_key: Specifies the location of the disk encryption key, which is a Key
     Vault Secret.
    :type disk_encryption_key: ~azure.mgmt.compute.v2016_03_30.models.KeyVaultSecretReference
    :param key_encryption_key: Specifies the location of the key encryption key in Key Vault.
    :type key_encryption_key: ~azure.mgmt.compute.v2016_03_30.models.KeyVaultKeyReference
...
class DiskInstanceView(msrest.serialization.Model):
    ...
    :type statuses: list[~azure.mgmt.compute.v2016_03_30.models.InstanceViewStatus]
    """
...
class ListUsagesResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.Usage]
...
class OSDisk(msrest.serialization.Model):
    ...
    :type encryption_settings: ~azure.mgmt.compute.v2016_03_30.models.DiskEncryptionSettings
    :param name: Required. The disk name.
    :type name: str
    :param vhd: Required. The virtual hard disk.
    :type vhd: ~azure.mgmt.compute.v2016_03_30.models.VirtualHardDisk
...
class OSProfile(msrest.serialization.Model):
    ...
    :param secrets: Specifies set of certificates that should be installed onto the virtual
     machine.
    :type secrets: list[~azure.mgmt.compute.v2016_03_30.models.VaultSecretGroup]
    """
...
class SshConfiguration(msrest.serialization.Model):
    ...
    :type public_keys: list[~azure.mgmt.compute.v2016_03_30.models.SshPublicKey]
    """
...
class VaultSecretGroup(msrest.serialization.Model):
    ...
    :param vault_certificates: The list of key vault references in SourceVault which contain
     certificates.
    :type vault_certificates: list[~azure.mgmt.compute.v2016_03_30.models.VaultCertificate]
    """
...
class VirtualMachine(Resource):
    ...
    :type identity: ~azure.mgmt.compute.v2016_03_30.models.VirtualMachineIdentity
    :param hardware_profile: Specifies the hardware settings for the virtual machine.
    :type hardware_profile: ~azure.mgmt.compute.v2016_03_30.models.HardwareProfile
    :param storage_profile: Specifies the storage settings for the virtual machine disks.
    :type storage_profile: ~azure.mgmt.compute.v2016_03_30.models.StorageProfile
    ...
    :type network_profile: ~azure.mgmt.compute.v2016_03_30.models.NetworkProfile
    :param diagnostics_profile: Specifies the boot diagnostic settings state.
     :code:`<br>`:code:`<br>`Minimum api-version: 2015-06-15.
    :type diagnostics_profile: ~azure.mgmt.compute.v2016_03_30.models.DiagnosticsProfile
...
class VirtualMachineExtension(Resource):
    ...
    :type instance_view: ~azure.mgmt.compute.v2016_03_30.models.VirtualMachineExtensionInstanceView
    """
...
class VirtualMachineExtensionInstanceView(msrest.serialization.Model):
    ...
    :type substatuses: list[~azure.mgmt.compute.v2016_03_30.models.InstanceViewStatus]
    :param statuses: The resource status information.
    :type statuses: list[~azure.mgmt.compute.v2016_03_30.models.InstanceViewStatus]
    """
...
class VirtualMachineImage(VirtualMachineImageResource):
    ...
    :type data_disk_images: list[~azure.mgmt.compute.v2016_03_30.models.DataDiskImage]
    """
...
class VirtualMachineInstanceView(msrest.serialization.Model):
    ...
    :type vm_agent: ~azure.mgmt.compute.v2016_03_30.models.VirtualMachineAgentInstanceView
    ...
    :param boot_diagnostics: Boot Diagnostics is a debugging feature which allows you to view
     ...
     view the output of your console log. :code:`<br>`:code:`<br>` Azure also enables you to see a
     screenshot of the VM from the hypervisor.
    :type boot_diagnostics: ~azure.mgmt.compute.v2016_03_30.models.BootDiagnosticsInstanceView
    :param statuses: The resource status information.
    :type statuses: list[~azure.mgmt.compute.v2016_03_30.models.InstanceViewStatus]
    """
...
class VirtualMachineListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.VirtualMachine]
...
class VirtualMachineScaleSet(Resource):
    ...
    :type sku: ~azure.mgmt.compute.v2016_03_30.models.Sku
    :param identity: The identity of the virtual machine scale set, if configured.
    :type identity: ~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSetIdentity
    :param upgrade_policy: The upgrade policy.
    :type upgrade_policy: ~azure.mgmt.compute.v2016_03_30.models.UpgradePolicy
...
class VirtualMachineScaleSetExtensionProfile(msrest.serialization.Model):
    ...
    :type extensions: list[~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSetExtension]
    """
...
class VirtualMachineScaleSetIPConfiguration(SubResource):
    ...
    :type load_balancer_inbound_nat_pools: list[~azure.mgmt.compute.v2016_03_30.models.SubResource]
    """
...
class VirtualMachineScaleSetListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSet]
...
class VirtualMachineScaleSetListSkusResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSetSku]
...
class VirtualMachineScaleSetStorageProfile(msrest.serialization.Model):
    ...
    :type os_disk: ~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSetOSDisk
    """
...
class VirtualMachineScaleSetVMListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSetVM]
...
class VirtualMachineScaleSetVMProfile(msrest.serialization.Model):
    ...
    :type os_profile: ~azure.mgmt.compute.v2016_03_30.models.VirtualMachineScaleSetOSProfile
...
class VirtualMachineSizeListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.compute.v2016_03_30.models.VirtualMachineSize]
    """
...
class WinRMConfiguration(msrest.serialization.Model):
    ...
    :type listeners: list[~azure.mgmt.compute.v2016_03_30.models.WinRMListener]
    """
