...
from .operations_async import BaselineOperations
from .. import models
...
class MonitorManagementClient(object):
    ...
    :vartype action_groups: $(python-base-namespace).v2018_09_01.aio.operations_async.ActionGroupsOperations
    :ivar metric_baseline: MetricBaselineOperations operations
    :vartype metric_baseline: $(python-base-namespace).v2018_09_01.aio.operations_async.MetricBaselineOperations
    :ivar baseline: BaselineOperations operations
    :vartype baseline: $(python-base-namespace).v2018_09_01.aio.operations_async.BaselineOperations
