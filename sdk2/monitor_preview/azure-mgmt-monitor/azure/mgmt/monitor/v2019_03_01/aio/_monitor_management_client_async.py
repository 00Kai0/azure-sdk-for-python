...
class MonitorManagementClient(object):
    ...
    :vartype action_groups: $(python-base-namespace).v2019_03_01.aio.operations_async.ActionGroupsOperations
    :ivar baselines: BaselinesOperations operations
    :vartype baselines: $(python-base-namespace).v2019_03_01.aio.operations_async.BaselinesOperations
