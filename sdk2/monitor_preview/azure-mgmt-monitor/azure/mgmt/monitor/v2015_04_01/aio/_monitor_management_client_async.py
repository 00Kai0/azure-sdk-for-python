...
from ._configuration_async import MonitorManagementClientConfiguration
...
class MonitorManagementClient(object):
    ...
    :vartype activity_logs: $(python-base-namespace).v2015_04_01.aio.operations_async.ActivityLogsOperations
    :ivar autoscale_settings: AutoscaleSettingsOperations operations
    :vartype autoscale_settings: $(python-base-namespace).v2015_04_01.aio.operations_async.AutoscaleSettingsOperations
    :ivar event_categories: EventCategoriesOperations operations
    :vartype event_categories: $(python-base-namespace).v2015_04_01.aio.operations_async.EventCategoriesOperations
    :ivar operations: Operations operations
    :vartype operations: $(python-base-namespace).v2015_04_01.aio.operations_async.Operations
    :ivar tenant_activity_logs: TenantActivityLogsOperations operations
    :vartype tenant_activity_logs: $(python-base-namespace).v2015_04_01.aio.operations_async.TenantActivityLogsOperations
