...
class MonitorManagementClient(object):
    ...
    :vartype action_groups: $(python-base-namespace).v2017_04_01.aio.operations_async.ActionGroupsOperations
    :ivar activity_log_alerts: ActivityLogAlertsOperations operations
    :vartype activity_log_alerts: $(python-base-namespace).v2017_04_01.aio.operations_async.ActivityLogAlertsOperations
