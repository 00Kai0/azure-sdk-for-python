...
class MonitorManagementClient(object):
    ...
    :vartype action_groups: $(python-base-namespace).v2018_03_01.aio.operations_async.ActionGroupsOperations
    :ivar metric_alerts: MetricAlertsOperations operations
    :vartype metric_alerts: $(python-base-namespace).v2018_03_01.aio.operations_async.MetricAlertsOperations
    :ivar metric_alerts_status: MetricAlertsStatusOperations operations
    :vartype metric_alerts_status: $(python-base-namespace).v2018_03_01.aio.operations_async.MetricAlertsStatusOperations
