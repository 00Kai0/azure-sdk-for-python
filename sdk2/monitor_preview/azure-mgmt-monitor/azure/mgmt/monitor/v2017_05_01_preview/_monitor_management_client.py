...
class MonitorManagementClient(object):
    ...
    :vartype diagnostic_settings_category: $(python-base-namespace).v2017_05_01_preview.operations.DiagnosticSettingsCategoryOperations
    :ivar diagnostic_settings: DiagnosticSettingsOperations operations
    :vartype diagnostic_settings: $(python-base-namespace).v2017_05_01_preview.operations.DiagnosticSettingsOperations
