...
class MgmtNetworkTest(AzureMgmtTestCase):
    ...
    def test_network(self, resource_group):
        ...
        result = self.mgmt_client.local_network_gateways.begin_update_tags(resource_group.name, LOCAL_NETWORK_GATEWAY_NAME, BODY)
        ...
        result = self.mgmt_client.virtual_network_gateway_connections.update_tags(resource_group.name, CONNECTION_NAME, BODY["tags"])
        result = result.result()
