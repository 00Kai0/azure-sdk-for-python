...
class MgmtStorageTest(AzureMgmtTestCase):
    ...
    def test_storage(self, resource_group):
        ...
        STORAGE_ACCOUNT_NAME = "storageaccountxxyyzzd"
        ...
        result = self.mgmt_client.private_endpoint_connections.put(resource_group.name, STORAGE_ACCOUNT_NAME, PRIVATE_ENDPOINT_CONNECTION_NAME, private_link_service_connection_state=BODY["private_link_service_connection_state"])
