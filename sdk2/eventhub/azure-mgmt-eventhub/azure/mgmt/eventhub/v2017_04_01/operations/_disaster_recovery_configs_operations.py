...
class DisasterRecoveryConfigsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.ArmDisasterRecoveryListResult"
        ...
        :type namespace_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ArmDisasterRecoveryListResult or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.ArmDisasterRecoveryListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        namespace_name,  # type: str
        alias,  # type: str
        partner_namespace=None,  # type: Optional[str]
        alternate_name=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        _parameters = models.ArmDisasterRecovery(partner_namespace=partner_namespace, alternate_name=alternate_name)
        api_version = "2017-04-01"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'ArmDisasterRecovery')
        body_content_kwargs['content'] = body_content
