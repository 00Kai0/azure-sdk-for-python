...
class NamespacesOperations:
    ...
    def list(
        self,
        **kwargs
    ) -> "models.EHNamespaceListResult":
        """Lists all the available Namespaces within a subscription, irrespective of the resource groups.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EHNamespaceListResult or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespaceListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace]
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace or ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EHNamespace"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def update(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: EHNamespace or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace or ~azure.mgmt.eventhub.v2017_04_01.models.EHNamespace or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EHNamespace"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def get_messaging_plan(
        self,
        resource_group_name: str,
        namespace_name: str,
        **kwargs
    ) -> "models.MessagingPlan":
        ...
        :type namespace_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: MessagingPlan or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.MessagingPlan
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MessagingPlan"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
        api_version = "2017-04-01"
        ...
        deserialized = self._deserialize('MessagingPlan', pipeline_response)
    ...
    def list_authorization_rules(
        ...
        namespace_name: str,
        **kwargs
    ) -> "models.AuthorizationRuleListResult":
        ...
        :type namespace_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AuthorizationRuleListResult or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.AuthorizationRuleListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def create_or_update_authorization_rule(
        ...
        **kwargs
        ...
        _parameters = models.AuthorizationRule(rights=rights)
        api_version = "2017-04-01"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'AuthorizationRule')
        body_content_kwargs['content'] = body_content
        request = self._client.put(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def regenerate_keys(
        ...
        namespace_name: str,
        authorization_rule_name: str,
        key_type: Union[str, "models.KeyType"],
        ...
        **kwargs
        ...
        :param authorization_rule_name: The authorization rule name.
        :type authorization_rule_name: str
        :param key_type: The access key to regenerate.
        ...
        _parameters = models.RegenerateAccessKeyParameters(key_type=key_type, key=key)
        api_version = "2017-04-01"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'RegenerateAccessKeyParameters')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    async def create_or_update_network_rule_set(
        ...
        **kwargs
        ...
        :type parameters: ~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSet
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetworkRuleSet or the result of cls(response)
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSet
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_network_rule_sets(
        ...
        namespace_name: str,
        **kwargs
    ) -> "models.NetworkRuleSetListResult":
        ...
        :rtype: ~azure.mgmt.eventhub.v2017_04_01.models.NetworkRuleSetListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
