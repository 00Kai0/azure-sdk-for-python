...
class NamespacesOperations(object):
    ...
    def create_or_update_virtual_network_rule(
        ...
        virtual_network_subnet_id=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        ...
        _parameters = models.VirtualNetworkRule(virtual_network_subnet_id=virtual_network_subnet_id)
        api_version = "2018-01-01-preview"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'VirtualNetworkRule')
        body_content_kwargs['content'] = body_content
        request = self._client.put(url, query_parameters, header_parameters, **body_content_kwargs)
