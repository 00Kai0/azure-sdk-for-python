...
class ConfigurationOperations(object):
    ...
    def patch(
        ...
        settings=None,  # type: Optional[Dict[str, str]]
        **kwargs  # type: Any
    ):
        ...
        _parameters = models.ClusterQuotaConfigurationProperties(settings=settings)
        ...
        body_content = self._serialize.body(_parameters, 'ClusterQuotaConfigurationProperties')
