...
class StorageAccountsOperations(object):
    ...
    def get_properties(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        expand=None,  # type: Optional[Union[str, "models.StorageAccountExpand"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.StorageAccount"
    ...
    def _restore_blob_ranges_initial(
        ...
        resource_group_name,  # type: str
        account_name,  # type: str
        time_to_restore,  # type: datetime.datetime
        blob_ranges,  # type: List["BlobRestoreRange"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.BlobRestoreStatus"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BlobRestoreStatus"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def begin_restore_blob_ranges(
     ...
     case letters only.
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_restore_blob_ranges.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/restoreBlobRanges'}
