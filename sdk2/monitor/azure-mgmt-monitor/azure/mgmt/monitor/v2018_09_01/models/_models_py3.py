...
class ActionGroupList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2018_09_01.models.ActionGroupResource]
...
class ActionGroupResource(Resource):
    ...
    :type email_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.EmailReceiver]
    :param sms_receivers: The list of SMS receivers that are part of this action group.
    :type sms_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.SmsReceiver]
    :param webhook_receivers: The list of webhook receivers that are part of this action group.
    :type webhook_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.WebhookReceiver]
    :param itsm_receivers: The list of ITSM receivers that are part of this action group.
    :type itsm_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.ItsmReceiver]
    ...
    :type voice_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.VoiceReceiver]
    :param logic_app_receivers: The list of logic app receivers that are part of this action group.
    :type logic_app_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.LogicAppReceiver]
    ...
    :type arm_role_receivers: list[~azure.mgmt.monitor.v2018_09_01.models.ArmRoleReceiver]
    """
...
class Baseline(msrest.serialization.Model):
    ...
    :param sensitivity: Required. The sensitivity of the baseline. Possible values include: 'Low',
     'Medium', 'High'.
    :type sensitivity: str or ~azure.mgmt.monitor.v2018_09_01.models.Sensitivity
...
class BaselineResponse(msrest.serialization.Model):
    ...
    :type metadata: list[~azure.mgmt.monitor.v2018_09_01.models.BaselineMetadataValue]
    """
