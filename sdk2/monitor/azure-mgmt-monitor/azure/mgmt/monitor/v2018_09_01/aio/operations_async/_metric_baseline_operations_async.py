...
class MetricBaselineOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.monitor.v2018_09_01.models.BaselineResponse
    ...
    async def calculate_baseline(
        ...
        **kwargs
        ...
        :param time_series_information: Information that need to be specified to calculate a baseline
         on a time series.
        :type time_series_information: ~azure.mgmt.monitor.v2018_09_01.models.TimeSeriesInformation
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CalculateBaselineResponse or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2018_09_01.models.CalculateBaselineResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
