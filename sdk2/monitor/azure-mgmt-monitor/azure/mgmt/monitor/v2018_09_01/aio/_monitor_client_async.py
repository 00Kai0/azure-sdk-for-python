...
class MonitorClient(object):
    ...
    :vartype action_groups: azure.mgmt.monitor.v2018_09_01.aio.operations_async.ActionGroupsOperations
    :ivar metric_baseline: MetricBaselineOperations operations
    :vartype metric_baseline: azure.mgmt.monitor.v2018_09_01.aio.operations_async.MetricBaselineOperations
    :ivar baseline: BaselineOperations operations
    :vartype baseline: azure.mgmt.monitor.v2018_09_01.aio.operations_async.BaselineOperations
