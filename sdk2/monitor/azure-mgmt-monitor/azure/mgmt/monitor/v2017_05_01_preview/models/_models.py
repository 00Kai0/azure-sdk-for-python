...
class DiagnosticSettingsCategoryResource(ProxyOnlyResource):
    ...
    :param category_type: The type of the diagnostic settings category. Possible values include:
     'Metrics', 'Logs'.
    :type category_type: str or ~azure.mgmt.monitor.v2017_05_01_preview.models.CategoryType
    """
...
class DiagnosticSettingsResource(ProxyOnlyResource):
    ...
    :type metrics: list[~azure.mgmt.monitor.v2017_05_01_preview.models.MetricSettings]
    :param logs: The list of logs settings.
    :type logs: list[~azure.mgmt.monitor.v2017_05_01_preview.models.LogSettings]
...
class DiagnosticSettingsResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2017_05_01_preview.models.DiagnosticSettingsResource]
    """
...
class LogSettings(msrest.serialization.Model):
    ...
    :type retention_policy: ~azure.mgmt.monitor.v2017_05_01_preview.models.RetentionPolicy
    """
...
class MetadataValue(msrest.serialization.Model):
    ...
    :type name: ~azure.mgmt.monitor.v2017_05_01_preview.models.LocalizableString
...
class Metric(msrest.serialization.Model):
    ...
    :type timeseries: list[~azure.mgmt.monitor.v2017_05_01_preview.models.TimeSeriesElement]
    """
...
class MetricDefinition(msrest.serialization.Model):
    ...
    :param dimensions: the name and the display name of the dimension, i.e. it is a localizable
     string.
    :type dimensions: list[~azure.mgmt.monitor.v2017_05_01_preview.models.LocalizableString]
    """
...
class MetricDefinitionCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2017_05_01_preview.models.MetricDefinition]
    """
...
class TimeSeriesElement(msrest.serialization.Model):
    ...
    :type metadatavalues: list[~azure.mgmt.monitor.v2017_05_01_preview.models.MetadataValue]
    ...
    :type data: list[~azure.mgmt.monitor.v2017_05_01_preview.models.MetricValue]
    """
