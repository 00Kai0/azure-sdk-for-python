...
class MonitorClient(object):
    ...
    :vartype diagnostic_settings_category: azure.mgmt.monitor.v2017_05_01_preview.aio.operations_async.DiagnosticSettingsCategoryOperations
    :ivar diagnostic_settings: DiagnosticSettingsOperations operations
    :vartype diagnostic_settings: azure.mgmt.monitor.v2017_05_01_preview.aio.operations_async.DiagnosticSettingsOperations
    :ivar metric_definitions: MetricDefinitionsOperations operations
    :vartype metric_definitions: azure.mgmt.monitor.v2017_05_01_preview.aio.operations_async.MetricDefinitionsOperations
    :ivar metrics: MetricsOperations operations
    :vartype metrics: azure.mgmt.monitor.v2017_05_01_preview.aio.operations_async.MetricsOperations
