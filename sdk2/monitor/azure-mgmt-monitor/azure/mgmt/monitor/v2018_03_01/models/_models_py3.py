...
class ActionGroupList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2018_03_01.models.ActionGroupResource]
...
class ActionGroupResource(Resource):
    ...
    :type email_receivers: list[~azure.mgmt.monitor.v2018_03_01.models.EmailReceiver]
    :param sms_receivers: The list of SMS receivers that are part of this action group.
    :type sms_receivers: list[~azure.mgmt.monitor.v2018_03_01.models.SmsReceiver]
    :param webhook_receivers: The list of webhook receivers that are part of this action group.
    :type webhook_receivers: list[~azure.mgmt.monitor.v2018_03_01.models.WebhookReceiver]
    :param itsm_receivers: The list of ITSM receivers that are part of this action group.
    :type itsm_receivers: list[~azure.mgmt.monitor.v2018_03_01.models.ItsmReceiver]
    ...
    :type voice_receivers: list[~azure.mgmt.monitor.v2018_03_01.models.VoiceReceiver]
    :param logic_app_receivers: The list of logic app receivers that are part of this action group.
    :type logic_app_receivers: list[~azure.mgmt.monitor.v2018_03_01.models.LogicAppReceiver]
...
class MultiMetricCriteria(msrest.serialization.Model):
    ...
    :type criterion_type: str or ~azure.mgmt.monitor.v2018_03_01.models.CriterionType
    ...
    :type time_aggregation: str or ~azure.mgmt.monitor.v2018_03_01.models.AggregationType
    :param dimensions: List of dimension conditions.
    :type dimensions: list[~azure.mgmt.monitor.v2018_03_01.models.MetricDimension]
    """
...
class DynamicMetricCriteria(MultiMetricCriteria):
    ...
    :type operator: str or ~azure.mgmt.monitor.v2018_03_01.models.DynamicThresholdOperator
    ...
    :type failing_periods: ~azure.mgmt.monitor.v2018_03_01.models.DynamicThresholdFailingPeriods
...
class MetricAlertCriteria(msrest.serialization.Model):
    ...
    :type odata_type: str or ~azure.mgmt.monitor.v2018_03_01.models.Odatatype
    """
...
class MetricAlertMultipleResourceMultipleMetricCriteria(MetricAlertCriteria):
    ...
    :type all_of: list[~azure.mgmt.monitor.v2018_03_01.models.MultiMetricCriteria]
    """
...
class MetricAlertResource(Resource):
    ...
    :type actions: list[~azure.mgmt.monitor.v2018_03_01.models.MetricAlertAction]
...
class MetricAlertResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2018_03_01.models.MetricAlertResource]
    """
...
class MetricAlertStatus(msrest.serialization.Model):
    ...
    :type properties: ~azure.mgmt.monitor.v2018_03_01.models.MetricAlertStatusProperties
    """
...
class MetricAlertStatusCollection(msrest.serialization.Model):
    ...
    :param value: the values for the alert rule resources.
    :type value: list[~azure.mgmt.monitor.v2018_03_01.models.MetricAlertStatus]
    """
