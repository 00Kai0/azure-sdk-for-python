...
class MonitorClient(object):
    ...
    :vartype action_groups: azure.mgmt.monitor.v2018_03_01.aio.operations_async.ActionGroupsOperations
    :ivar metric_alerts: MetricAlertsOperations operations
    :vartype metric_alerts: azure.mgmt.monitor.v2018_03_01.aio.operations_async.MetricAlertsOperations
    :ivar metric_alerts_status: MetricAlertsStatusOperations operations
    :vartype metric_alerts_status: azure.mgmt.monitor.v2018_03_01.aio.operations_async.MetricAlertsStatusOperations
