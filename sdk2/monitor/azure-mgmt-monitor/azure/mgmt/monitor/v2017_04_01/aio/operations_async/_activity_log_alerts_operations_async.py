...
class ActivityLogAlertsOperations:
    ...
    :type models: ~azure.mgmt.monitor.v2017_04_01.models
    ...
    async def create_or_update(
        ...
        **kwargs
        ...
        :type activity_log_alert: ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActivityLogAlertResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertResource or ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertResource
    ...
    async def get(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActivityLogAlertResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ActivityLogAlertResource"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    async def update(
        ...
        **kwargs
        ...
        _activity_log_alert_patch = models.ActivityLogAlertPatchBody(tags=tags, enabled=enabled)
        api_version = "2017-04-01"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_activity_log_alert_patch, 'ActivityLogAlertPatchBody')
        body_content_kwargs['content'] = body_content
    ...
    def list_by_subscription_id(
        self,
        **kwargs
    ) -> "models.ActivityLogAlertList":
        """Get a list of all activity log alerts in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ActivityLogAlertList or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
