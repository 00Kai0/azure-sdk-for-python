...
class MonitorClient(object):
    ...
    :vartype action_groups: azure.mgmt.monitor.v2017_04_01.aio.operations_async.ActionGroupsOperations
    :ivar activity_log_alerts: ActivityLogAlertsOperations operations
    :vartype activity_log_alerts: azure.mgmt.monitor.v2017_04_01.aio.operations_async.ActivityLogAlertsOperations
