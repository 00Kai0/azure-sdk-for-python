...
class ActionGroupList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2017_04_01.models.ActionGroupResource]
...
class ActionGroupResource(Resource):
    ...
    :type email_receivers: list[~azure.mgmt.monitor.v2017_04_01.models.EmailReceiver]
    :param sms_receivers: The list of SMS receivers that are part of this action group.
    :type sms_receivers: list[~azure.mgmt.monitor.v2017_04_01.models.SmsReceiver]
    :param webhook_receivers: The list of webhook receivers that are part of this action group.
    :type webhook_receivers: list[~azure.mgmt.monitor.v2017_04_01.models.WebhookReceiver]
    :param itsm_receivers: The list of ITSM receivers that are part of this action group.
    :type itsm_receivers: list[~azure.mgmt.monitor.v2017_04_01.models.ItsmReceiver]
...
class ActivityLogAlertActionList(msrest.serialization.Model):
    ...
    :type action_groups: list[~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertActionGroup]
    """
...
class ActivityLogAlertAllOfCondition(msrest.serialization.Model):
    ...
    :type all_of: list[~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertLeafCondition]
    """
...
class ActivityLogAlertList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertResource]
    :param next_link: Provides the link to retrieve the next set of elements.
    :type next_link: str
    """
...
class ActivityLogAlertResource(Resource):
    ...
    :type condition: ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertAllOfCondition
    :param actions: The actions that will activate when the condition is met.
    :type actions: ~azure.mgmt.monitor.v2017_04_01.models.ActivityLogAlertActionList
