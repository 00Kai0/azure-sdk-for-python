...
class Metric(msrest.serialization.Model):
    ...
    :type timeseries: list[~azure.mgmt.monitor.v2018_01_01.models.TimeSeriesElement]
    """
...
class MetricDefinition(msrest.serialization.Model):
    ...
    :param primary_aggregation_type: the primary aggregation type value defining how to use the
     ...
     'Total'.
    :type primary_aggregation_type: str or ~azure.mgmt.monitor.v2018_01_01.models.AggregationType
    ...
    :param dimensions: the name and the display name of the dimension, i.e. it is a localizable
     string.
    :type dimensions: list[~azure.mgmt.monitor.v2018_01_01.models.LocalizableString]
    """
...
class MetricDefinitionCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2018_01_01.models.MetricDefinition]
    """
...
class TimeSeriesElement(msrest.serialization.Model):
    ...
    :type metadatavalues: list[~azure.mgmt.monitor.v2018_01_01.models.MetadataValue]
