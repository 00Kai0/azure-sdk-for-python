...
class ActivityLogAlertList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertResource]
    """
...
class ActivityLogAlertResource(Resource):
    ...
    :type condition: ~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertAllOfCondition
    :param actions: The actions that will activate when the condition is met.
    :type actions: ~azure.mgmt.monitor.v2017_03_01_preview.models.ActivityLogAlertActionList
