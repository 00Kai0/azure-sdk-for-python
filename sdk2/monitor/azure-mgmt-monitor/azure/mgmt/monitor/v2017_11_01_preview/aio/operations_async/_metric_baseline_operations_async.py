...
class MetricBaselineOperations:
    ...
    :type models: ~azure.mgmt.monitor.v2017_11_01_preview.models
    ...
    async def get(
        ...
        **kwargs
        ...
        :type result_type: str or ~azure.mgmt.monitor.v2017_11_01_preview.models.ResultType
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BaselineResponse or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_11_01_preview.models.BaselineResponse
    ...
    async def calculate_baseline(
        ...
        **kwargs
        ...
        :param time_series_information: Information that need to be specified to calculate a baseline
         on a time series.
        :type time_series_information: ~azure.mgmt.monitor.v2017_11_01_preview.models.TimeSeriesInformation
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CalculateBaselineResponse or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2017_11_01_preview.models.CalculateBaselineResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
