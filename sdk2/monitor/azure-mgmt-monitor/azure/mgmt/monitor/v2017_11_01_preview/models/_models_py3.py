...
class Baseline(msrest.serialization.Model):
    ...
    :param sensitivity: Required. the sensitivity of the baseline. Possible values include: 'Low',
     'Medium', 'High'.
    :type sensitivity: str or ~azure.mgmt.monitor.v2017_11_01_preview.models.Sensitivity
...
class BaselineMetadataValue(msrest.serialization.Model):
    ...
    :type name: ~azure.mgmt.monitor.v2017_11_01_preview.models.LocalizableString
...
class BaselineResponse(msrest.serialization.Model):
    ...
    :vartype name: ~azure.mgmt.monitor.v2017_11_01_preview.models.LocalizableString
    ...
    :type baseline: list[~azure.mgmt.monitor.v2017_11_01_preview.models.Baseline]
    :param metadata: the baseline metadata values.
    :type metadata: list[~azure.mgmt.monitor.v2017_11_01_preview.models.BaselineMetadataValue]
    """
