...
class EventCategoriesOperations:
    """EventCategoriesOperations async operations.
    ...
    def list(
        self,
        **kwargs
    ) -> "models.EventCategoryCollection":
        ...
        :return: EventCategoryCollection or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2015_04_01.models.EventCategoryCollection
