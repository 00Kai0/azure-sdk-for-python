...
class AutoscaleNotification(msrest.serialization.Model):
    ...
    :type email: ~azure.mgmt.monitor.v2015_04_01.models.EmailNotification
    :param webhooks: the collection of webhook notifications.
    :type webhooks: list[~azure.mgmt.monitor.v2015_04_01.models.WebhookNotification]
    """
...
class AutoscaleProfile(msrest.serialization.Model):
    ...
    :type capacity: ~azure.mgmt.monitor.v2015_04_01.models.ScaleCapacity
    ...
    :type rules: list[~azure.mgmt.monitor.v2015_04_01.models.ScaleRule]
    :param fixed_date: the specific date-time for the profile. This element is not used if the
     Recurrence element is used.
    :type fixed_date: ~azure.mgmt.monitor.v2015_04_01.models.TimeWindow
    ...
    :type recurrence: ~azure.mgmt.monitor.v2015_04_01.models.Recurrence
    """
...
class AutoscaleSettingResource(Resource):
    ...
    :type profiles: list[~azure.mgmt.monitor.v2015_04_01.models.AutoscaleProfile]
    :param notifications: the collection of notifications.
    :type notifications: list[~azure.mgmt.monitor.v2015_04_01.models.AutoscaleNotification]
...
class AutoscaleSettingResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2015_04_01.models.AutoscaleSettingResource]
...
class EventCategoryCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2015_04_01.models.LocalizableString]
    """
...
class EventDataCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2015_04_01.models.EventData]
...
class MetricTrigger(msrest.serialization.Model):
    ...
    :type statistic: str or ~azure.mgmt.monitor.v2015_04_01.models.MetricStatisticType
    ...
    :type time_aggregation: str or ~azure.mgmt.monitor.v2015_04_01.models.TimeAggregationType
    ...
    :type operator: str or ~azure.mgmt.monitor.v2015_04_01.models.ComparisonOperationType
...
class Operation(msrest.serialization.Model):
    ...
    :type display: ~azure.mgmt.monitor.v2015_04_01.models.OperationDisplay
    """
...
class Recurrence(msrest.serialization.Model):
    ...
    :type frequency: str or ~azure.mgmt.monitor.v2015_04_01.models.RecurrenceFrequency
...
class ScaleAction(msrest.serialization.Model):
    ...
    :type direction: str or ~azure.mgmt.monitor.v2015_04_01.models.ScaleDirection
