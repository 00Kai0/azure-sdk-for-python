...
class GuestDiagnosticsSettingsAssociationOperations(object):
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :param diagnostic_settings_association: The diagnostic settings association to create or
         update.
        :type diagnostic_settings_association: ~azure.mgmt.monitor.v2018_06_01_preview.models.GuestDiagnosticSettingsAssociationResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GuestDiagnosticSettingsAssociationResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2018_06_01_preview.models.GuestDiagnosticSettingsAssociationResource or ~azure.mgmt.monitor.v2018_06_01_preview.models.GuestDiagnosticSettingsAssociationResource
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GuestDiagnosticSettingsAssociationResource or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2018_06_01_preview.models.GuestDiagnosticSettingsAssociationResource
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.GuestDiagnosticSettingsAssociationResource"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})
    ...
    def update(
        ...
        guest_diagnostic_settings_name=None,  # type: Optional[str]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.GuestDiagnosticSettingsAssociationResource"
        ...
        _parameters = models.GuestDiagnosticSettingsAssociationResourcePatch(tags=tags, guest_diagnostic_settings_name=guest_diagnostic_settings_name)
        api_version = "2018-06-01-preview"
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'GuestDiagnosticSettingsAssociationResourcePatch')
        body_content_kwargs['content'] = body_content
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.GuestDiagnosticSettingsAssociationList"
        """Get a list of all guest diagnostic settings association in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: GuestDiagnosticSettingsAssociationList or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2018_06_01_preview.models.GuestDiagnosticSettingsAssociationList
        :raises: ~azure.core.exceptions.HttpResponseError
        """
