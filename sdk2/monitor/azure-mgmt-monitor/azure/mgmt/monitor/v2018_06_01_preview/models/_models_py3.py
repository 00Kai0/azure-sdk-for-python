...
class DataSource(msrest.serialization.Model):
    ...
    :type kind: str or ~azure.mgmt.monitor.v2018_06_01_preview.models.DataSourceKind
    :param configuration: Required.
    :type configuration: ~azure.mgmt.monitor.v2018_06_01_preview.models.DataSourceConfiguration
    :param sinks: Required.
    :type sinks: list[~azure.mgmt.monitor.v2018_06_01_preview.models.SinkConfiguration]
    """
...
class DataSourceConfiguration(msrest.serialization.Model):
    ...
    :type providers: list[~azure.mgmt.monitor.v2018_06_01_preview.models.EtwProviderConfiguration]
    ...
    :type event_logs: list[~azure.mgmt.monitor.v2018_06_01_preview.models.EventLogConfiguration]
    """
...
class EtwProviderConfiguration(msrest.serialization.Model):
    ...
    :type events: list[~azure.mgmt.monitor.v2018_06_01_preview.models.EtwEventConfiguration]
    """
...
class GuestDiagnosticSettingsPatchResource(msrest.serialization.Model):
    ...
    :param data_sources: the array of data source object which are configured to collect and send
     data.
    :type data_sources: list[~azure.mgmt.monitor.v2018_06_01_preview.models.DataSource]
    :param proxy_setting:
...
class SinkConfiguration(msrest.serialization.Model):
    ...
    :param kind: Required.  Possible values include: 'EventHub', 'ApplicationInsights',
     'LogAnalytics'.
    :type kind: str or ~azure.mgmt.monitor.v2018_06_01_preview.models.SinkConfigurationKind
    """
