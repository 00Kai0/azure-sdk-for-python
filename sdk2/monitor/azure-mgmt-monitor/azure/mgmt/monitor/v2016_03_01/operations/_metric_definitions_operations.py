...
class MetricDefinitionsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.MetricDefinitionCollection"
     ...
     other syntax is allowed.
        ...
        :return: MetricDefinitionCollection or the result of cls(response)
        :rtype: ~azure.mgmt.monitor.v2016_03_01.models.MetricDefinitionCollection
