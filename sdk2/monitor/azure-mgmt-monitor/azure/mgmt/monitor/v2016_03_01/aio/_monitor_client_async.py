...
class MonitorClient(object):
    ...
    :vartype alert_rule_incidents: azure.mgmt.monitor.v2016_03_01.aio.operations_async.AlertRuleIncidentsOperations
    :ivar alert_rules: AlertRulesOperations operations
    :vartype alert_rules: azure.mgmt.monitor.v2016_03_01.aio.operations_async.AlertRulesOperations
    :ivar log_profiles: LogProfilesOperations operations
    :vartype log_profiles: azure.mgmt.monitor.v2016_03_01.aio.operations_async.LogProfilesOperations
    :ivar metric_definitions: MetricDefinitionsOperations operations
    :vartype metric_definitions: azure.mgmt.monitor.v2016_03_01.aio.operations_async.MetricDefinitionsOperations
