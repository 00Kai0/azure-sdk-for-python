...
class AlertRuleResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2016_03_01.models.AlertRuleResource]
    """
...
class IncidentListResult(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2016_03_01.models.Incident]
    """
...
class LogProfileCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2016_03_01.models.LogProfileResource]
    """
...
class LogProfileResource(Resource):
    ...
    :type retention_policy: ~azure.mgmt.monitor.v2016_03_01.models.RetentionPolicy
    """
...
class ManagementEventAggregationCondition(msrest.serialization.Model):
    ...
    :type operator: str or ~azure.mgmt.monitor.v2016_03_01.models.ConditionOperator
...
class ManagementEventRuleCondition(RuleCondition):
    ...
    :type aggregation: ~azure.mgmt.monitor.v2016_03_01.models.ManagementEventAggregationCondition
    """
...
class MetricDefinition(msrest.serialization.Model):
    ...
    :param primary_aggregation_type: the primary aggregation type value defining how to use the
     ...
     'Total'.
    :type primary_aggregation_type: str or ~azure.mgmt.monitor.v2016_03_01.models.AggregationType
...
class MetricDefinitionCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.monitor.v2016_03_01.models.MetricDefinition]
    """
...
class RuleManagementEventDataSource(RuleDataSource):
    ...
    :type claims: ~azure.mgmt.monitor.v2016_03_01.models.RuleManagementEventClaimsDataSource
    """
...
class ThresholdRuleCondition(RuleCondition):
    ...
    :type time_aggregation: str or ~azure.mgmt.monitor.v2016_03_01.models.TimeAggregationOperator
    """
