...
class ResourcesOperations:
    ...
    def list_by_resource_group(
     ...
     ``$expand=createdTime,changedTime``.
        ...
        :rtype: ~azure.mgmt.resource.resources.v2019_10_01.models.ResourceListResult
    ...
    async def _move_resources_initial(
        ...
        **kwargs
        ...
        _parameters = models.ResourcesMoveInfo(resources=resources, target_resource_group=target_resource_group)
        api_version = "2019-10-01"
        ...
        body_content = self._serialize.body(_parameters, 'ResourcesMoveInfo')
    ...
    async def validate_move_resources(
        self,
        source_resource_group_name: str,
        resources: Optional[List[str]] = None,
        target_resource_group: Optional[str] = None,
    ...
    async def create_or_update(
     ...
     insensitive.
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.resource.resources.v2019_10_01.models.GenericResource]
